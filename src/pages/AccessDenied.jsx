...
export default function AccessDenied() {
  return (
    <div className="flex h-screen flex-col items-center justify-between p-4">
      ...
      <h1 className="text-3xl  font-bold tracking-wider text-gray-400">
        Access Denied
      </h1>
      <p className="text-gray-600">
        Only authenticated users have acess to this
      </p>
      <div className="flex flex-col items-center">
        ...
        <p>
          ...
          <Link className="text-blue-700 underline" to="/sign-up">
            Sign Up
          </Link>
        </p>
      </div>
